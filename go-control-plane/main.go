...
func main() {
	...
	api.Post("/training/plates/ai-review", aiReviewTrainingSamples)
	...
	api.Post("/training/models/versions/snapshot", snapshotModelVersion)
	api.Post("/training/models/versions/:version/deploy", deployModelVersion)
	api.Put("/training/models/versions/:version/label", renameModelVersion)
	api.Delete("/training/models/versions/:version", deleteModelVersion)
