...
type FrameTask struct {
	...
	RoboflowApiKey       string                 `protobuf:"bytes,10,opt,name=roboflow_api_key,json=roboflowApiKey,proto3" json:"roboflow_api_key,omitempty"` // API key for auto-downloading Roboflow datasets
...
func (x *FrameTask) GetRoboflowApiKey() string {
	if x != nil {
		return x.RoboflowApiKey
	}
	return ""
}
...
const file_facerec_proto_rawDesc = "" +
	"\n" +
	"\rfacerec.proto\x12\afacerec\"\x88\x03\n" +
	"\tFrameTask\x12\x17\n" +
